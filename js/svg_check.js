...
!setTimeout(function(){
   ...
   // $("#drawing_path").attr("d","M150 0 L75 200 L225 200 Z M150 10 L70 150 L200 200 Z");
   // $("#drawing_path").attr("d","M150 10 L70 150 L200 200 Z");
 //  console.log(mark_id);
  // var rectangle_total_number;
 //  var rectangle_total_value;
 //  var radio_total_info;

   var rectangle_total_num = rectangle_total_value.length;
   var d = "";
   for(let i=0;i<rectangle_total_num;i++)
   {
       d  += rectangle_total_value[i];
       rectangle_id = rectangle_total_number[i] - 1;
       add_one_rectangle_id();
       add_one_rectangle();
       $(`#Draw_path${rectangle_id}`).bind({"click":draw_path_click});
       $(`#Item${rectangle_id}`).bind({"click":li_item_click});
       $(`#Draw_path${rectangle_id}`).attr("d",rectangle_total_value[i]);
       radio_total_value[rectangle_id] = radio_total_info[i];
   }
   console.log(d);
   $("#drawing_path").attr("d",d);
        ...
        */
        ...
        function drawing_rectangle_information(event){
          ...
          function add_one_rectangle_id(){
            ...
            //向li标签内添加内容
            BoundingIdContext = "框"+rectangle_id;
  ...
  //  var j = 0;
        ...
        function get_all_value(){
          rectangle_all_length = $(".Rectangle_g").length;
           console.log($(".Rectangle_g"));
          for(let i=0;i<rectangle_all_length;i++){
          ...
          rectangle_total_value_string = JSON.stringify(rectangle_total_value);
          rectangle_total_number_string = JSON.stringify(rectangle_total_number);
          radio_total_info_string = JSON.stringify(radio_total_info);

          $.ajax({
            url:"update_mark",
            data:{
            "rectangle_total_value":rectangle_total_value_string,
            "rectangle_total_number":rectangle_total_number_string,
            "radio_total_info":radio_total_info_string,
            "mark_id":mark_id
              },
             type:"POST",  
             success:function(res){
      ...
      else
      {
        ...
        //turn_points(rectangle_total_value);
        }

        function turn_points(rectangle_total_value) {
          console.log("矩阵的路径值turn",rectangle_total_value);
